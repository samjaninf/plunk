...
## [1.0.0](https://github.com/samjaninf/plunk/compare/v0.14.0...v1.0.0) (2026-09-06)
...
* Add additional checks for website, NS records and personal emails ([0a67a82](https://github.com/samjaninf/plunk/commit/0a67a8278f45d89b1abdf55be1cf251a470595cf))
...
* Remove domain from AWS if no longer in use by other projects ([e6baace](https://github.com/samjaninf/plunk/commit/e6baace00d5f7a109e717b8a996bc2cda52cc9fa))
...
* Improve email verification logic by prioritizing MX record checks and clarifying domain existence validation ([26800a8](https://github.com/samjaninf/plunk/commit/26800a85538fc90aa05fc43b1cc33cef95d8fb32))
